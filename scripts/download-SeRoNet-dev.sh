...
IPA_ROS_URI="http://ros-model.seronet-project.de/updatesite/latest"
...
# this is the SmartMDSD repository URL where the SmartMDSD plugins are searched for installation
...
SMARTMDSD_FEATURE="org.eclipse.smartmdsd.toolchain.source.feature.group"
...
rm ${ECLIPSE_MODELING_TOOLS_ARCHIVE}
cd eclipse

echo "installing Eclipse SmartMDSD Plugins..."
...
echo "installing IPA ROS Plugins..."
./eclipse $ECLIPSE_ARGUMENST -repository $IPA_ROS_URI -installIU de.fraunhofer.ipa.ros.feature.feature.group
